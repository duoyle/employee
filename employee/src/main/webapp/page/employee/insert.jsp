...
<head>
  ...
  <script type="text/javascript">
      $(function () {
          ...
          }, '${ctx}/employee/insert.do');
      });

      function selDept() {
          myModal.find('.modal-body').load('${ctx}/dept/select'); // select.jsp中的代码每打开一次执行一次
...
<div class="container">
  ...
  <form role="form" id="addForm" class="form-horizontal" method="post">
    <div class="form-group">
      ...
      <div class="col-md-4">
        <input class="form-control" type="text" name="empNo" id="empNo" placeholder="输入员工编号"/>
      </div>
    </div>
    <div class="form-group">
