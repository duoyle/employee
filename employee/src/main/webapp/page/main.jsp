...
<div>
  <div class="right-side-content">
    <iframe name="contentFrame" src="${ctx}/home" width="100%" height="100%" scrolling="auto"
        ...
        <div class="lsm-sidebar">
          <ul>
            <li id="F100" class="lsm-sidebar-item">
              ...
              <ul>
                <li id="F110"><a href="${ctx}/dept/list" target="contentFrame">
                  <span>部门列表</span></a></li>
                <li id="F120"><a href="${ctx}/dept/insert" target="contentFrame">
                  <span>添加部门</span></a></li>
            ...
            <li id="F200" class="lsm-sidebar-item">
              ...
              <ul>
                <li id="F210"><a href="${ctx}/employee/list" target="contentFrame">
                  <span>员工列表</span></a></li>
                <li id="F220"><a href="${ctx}/employee/insert" target="contentFrame">
                  <span>添加员工</span></a></li>
            ...
            <li id="F300" class="lsm-sidebar-item">
              ...
              <ul>
                <li id="F310"><a href="${ctx}/history/list" target="contentFrame"><span>查看</span></a></li>
